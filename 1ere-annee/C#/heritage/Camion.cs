...
namespace heritage
{
    internal class Camion : Véhicule
    {
        public int stockage { get; set; }

        public Camion(int stockage, int Nbroue, int Kilometrage, double puissance, string sourceEnergetique, string Nom, string Marque, double cout, int CapaciteCarburant, int CapaciteActu) : base(Nbroue, Kilometrage, puissance, sourceEnergetique, Nom, Marque, cout, CapaciteCarburant, CapaciteActu)
        {
